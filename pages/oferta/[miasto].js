...
const Oferta = () => {
  ...
  return (
    <section className="text-gray-400 body-font">
      <div className="max-w-7xl mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
          <h1 className="mb-5 sm:text-6xl text-5xl items-center xl:w-2/2 text-gray-200">
            Indywidualne podejście do klientów w {cityName}
          </h1>
          <p className="mb-8 xl:w-3/4 text-gray-400 text-lg">
            Wiemy, że każdy klient w <b>{cityName}</b> jest inny i ma swoje unikalne potrzeby.
            ...
            , aby dowiedzieć się więcej o naszych usługach i cenach w <b>{cityName}</b>.
          </p>
      ...
      Jesteśmy gotowi dostarczyć kompleksowe rozwiązania, dopasowane do Twoich potrzeb w <b>{cityName}</b>.
      </p>
      ...
      <div className="grr max-w-7xl pt-20 mx-auto text-center">
        ...
        <h1 className="mb-8 text-2xl Avenir font-semibold text-gray-400 text-center">
          Pozwól nam pomóc ci osiągnąć sukces w mediach społecznościowych w <b>{cityName}</b>
        </h1>
